...
public class Nombre extends javax.swing.JFrame {
    ...
    private void agregarnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_agregarnActionPerformed
        if (nombrel.getText().equals("")) {
            JOptionPane.showMessageDialog(null, "Porfavor, ingrese un valor valido", "VALOR INVALIDO" , 0);
        } else {
    ...
    private void jLabel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MouseClicked
        ...
        JOptionPane.showMessageDialog(null, "Claro, era super xd poner una x ahi la verdad, solo la puse ahi para seguir el formato:/", "ALERTA DE CURIOSO" , 0);
